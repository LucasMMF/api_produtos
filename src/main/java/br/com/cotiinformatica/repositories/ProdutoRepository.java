...
public class ProdutoRepository {
	...
	public void create(Produto produto) throws Exception {
		...
		String command = "INSERT INTO produto(nome, preco, quantidade) VALUES(?,?,?)";
	...
	public void update(Produto produto) throws Exception {
		...
		Connection connection = ConnectionFactory.getConnection();
		String command = "UPDATE produto SET nome = ?, preco = ?, quantidade = ? WHERE idproduto = ?";
	...
	public void delete(Integer idProduto) throws Exception {
		...
		Connection connection = ConnectionFactory.getConnection();
		String command = "DELETE FROM produto WHERE idproduto = ?";
